...
/*
 *  (c) 2022 punkt.de GmbH - Karlsruhe, Germany - https://punkt.de
 *  All rights reserved.
 *
 *  Zip archive extractor for zips from Flip PDF Professional
 */
...
class FlipArchiveExtractor implements ArchiveExtractorInterface
{
    /**
     * @var LoggerInterface
     */
    ...
    public function extractArchive(AssetInterface $asset, string $ePaperDirectory): void
    {
        ...
        // In case the complete folder was zipped we only have one directory and
